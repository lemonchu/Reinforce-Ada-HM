...
exp_name=Reinforce-Ada_refine_rewrite_debug_${model_name}

# Output
ckpts_dir="./outputs/${project_name}/${exp_name}"
mkdir -p "${ckpts_dir}/logs"

# Debug training setting: 2 GPUs, about 1/16 of the normal prompt batch.
NGPUS=2
train_prompt_bsz=64
...
difficult_refine_space=32
enable_rewrite=True
rewrite_per_prompt=4
difficult_rewrite_space=16
rewrite_source_bsz=${train_prompt_bsz}
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.log_val_generations=0 2>&1 | tee ${ckpts_dir}/logs/log
